...
import com.hyunsungkr.employerapp.adapter.EmployeeAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public ActivityResultLauncher<Intent> launcher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    // AddActivity가 넘겨준 Employee 객체를 받아서
                    // employeeList에 넣어주고 화면을 갱신해준다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 액션바의 타이틀 변경법
        getSupportActionBar().setTitle("직원 목록");
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET,
                URL + "employees.json", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this,"데이터파싱에러",Toast.LENGTH_SHORT).show();
                    return;
                }
